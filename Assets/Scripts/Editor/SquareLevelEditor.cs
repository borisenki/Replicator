...
public class SquareLevelEditor : Editor
{
    ...
    private void OnEnable()
    {
        ...
        _list = new ReorderableList(serializedObject, serializedObject.FindProperty("LevelDatas"), true, true, false,
            true);
    ...
    ReorderableList CreateList(SerializedObject obj, SerializedProperty prop)
    {
        ...
        list.drawHeaderCallback = rect => { EditorGUI.LabelField(rect, "Square Levels"); };
